...
namespace WS_Proveedor.Validators
{
    ...
    {
        private static readonly Regex FechaRegex =
        ...
        public static bool EsValida(CalcularFacturacionRequest solicitud)
        {
            ...
            if (!DateTime.TryParse(solicitud.FechaCalculo, out DateTime fechaCalculo)) return false;
            if (!DateTime.TryParse(solicitud.FechaMaximaPago, out DateTime fechaMaximaPago)) return false;

            return fechaMaximaPago >= fechaCalculo;
        }
    }
}
